...
from sofaopt.dashboard.playground.objectives import axis_profiles, make_landscape, score_grid
from sofaopt.dashboard.playground.optimizers import ALGO_LABELS
