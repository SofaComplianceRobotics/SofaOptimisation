...
CMAES_RESTARTS = "OPT_CMAES_RESTARTS"      # int override for project.cmaes_restarts (IPOP cap)
STALL_GENERATIONS = "OPT_STALL_GENERATIONS"  # int override for project.stall_generations
CMAES_INC_POPSIZE = "OPT_CMAES_INC_POPSIZE"  # int override for project.cmaes_inc_popsize
RESTART_ON_CONVERGENCE = "OPT_RESTART_ON_CONVERGENCE"  # "1"/"true": convergence-triggered restarts
WARM_RESTARTS = "OPT_WARM_RESTARTS"        # "1"/"true": re-seed restarts from the incumbent
DEDUP_TRIALS = "OPT_DEDUP_TRIALS"          # "1"/"true": reuse scores for repeated param vectors
