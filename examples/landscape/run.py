...
Usage::
    ...
    python run.py                        # rastrigin, convergence-triggered warm restarts
    ...
    python run.py --variant stall-restart # OLD behavior (cold restart on a plateau)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--variant",
        choices=["default", "converged", "plain", "stall-restart", "noisy"],
        default="default",
